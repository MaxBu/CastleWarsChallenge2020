...
public class RogueConME : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        enemyMage = GameObject.FindGameObjectWithTag("ourmage");
        enemyCastle = GameObject.FindGameObjectWithTag("ourcastle");
